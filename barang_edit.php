...
} // TODO: Penutup POST UPDATE


// TODO: TAMPILKAN DATA UNTUK DIEDIT
...
$dataHargaReseller	= isset($_POST['txtHargaReseller']) ? $_POST['txtHargaReseller'] : $myData['reseller'];
...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Ubah Barang <small>Mengubah data barang lama dengan data barang yang baru</small></h1>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		<tr>
			...
			<td width="83%"><input class=" col-sm-2 form-control" name="textfield" value="<?php echo $dataKode; ?>" size="14" maxlength="10" readonly="readonly" />
				<input name="txtKode" type="hidden" value="<?php echo $dataKode; ?>" /><span for="" style="font-size:10px;color:#000;">Nomor kode sudah ditentukan saat mengubah data barang</span>
			</td>
		</tr>
		<tr>
			...
			<td><input class=" col-sm-5 form-control" name="txtNama" value="<?php echo $dataNama; ?>" size="80" maxlength="100" />
				<input class=" col-sm-5 form-control" name="txtNamaLama" type="hidden" value="<?php echo $myData['nm_obat']; ?>" />
		...
		<tr>
			...
			<td><strong>:</strong></td>
			<td><input class=" col-sm-2 form-control" name="txtHargaModal" value="<?php echo $dataHargaModal; ?>" size="20" maxlength="12" onblur="if (value == '') {value = '0'}" onfocus="if (value == '0') {value =''}" />
				<span for="" style="font-size:10px;color:#000;">Masukan harga modal barang</span>
			</td>
		</tr>
		<tr>
			<td><strong>Harga Jual (Rp.) </strong></td>
			<td><strong>:</strong></td>
			<td><input class=" col-sm-2 form-control" name="txtHargaJual" value="<?php echo $dataHargaJual; ?>" size="20" maxlength="12" onblur="if (value == '') {value = '0'}" onfocus="if (value == '0') {value =''}" />
				<span for="" style="font-size:10px;color:#000;">Masukan harga jual barang</span>
			</td>
		</tr>
		<tr>
			<td><strong>Harga Reseller (Rp.) </strong></td>
			<td><strong>:</strong></td>
			<td><input class=" col-sm-2 form-control" name="txtHargaReseller" value="<?php echo $dataHargaReseller; ?>" size="20" maxlength="12" onblur="if (value == '') {value = '0'}" onfocus="if (value == '0') {value =''}" />
				<span for="" style="font-size:10px;color:#000;">Masukan harga untuk reseller</span>
			</td>
		</tr>
		<tr>
			...
			<td><input class=" col-sm-1 form-control" name="txtStok" value="<?php echo $dataStok; ?>" size="14" maxlength="10" />
				<span for="" style="font-size:10px;color:#000;">Masukan jumlah barang untuk stok baik untuk menambah stok atau mengurangi stok</span>
			</td>
		</tr>
		<tr>
